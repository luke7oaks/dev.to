...
gem "administrate", "~> 0.18", ">= 0.18.0"
gem "ahoy_email", "~> 1.0", ">= 1.0.0"
gem "airbrake", "~> 7.4"
gem "algoliasearch-rails", "~> 1.20", ">= 1.20.6"
...
gem "cloudinary", "~> 1.9"
gem "counter_culture", "~> 1.9", ">= 1.9.1"
gem "csv_shaper", "~> 1.3", ">= 1.3.1"
gem "dalli", "~> 2.7"
...
gem "redcarpet", "~> 3.4"
gem "reverse_markdown", "~> 1.2", ">= 1.2.0"
gem "rolify", "~> 5.2"
gem "rouge", "~> 3.2"
gem "s3_direct_upload", "~> 0.1"
gem "sass-rails", "~> 6.0", ">= 6.0.0"
gem "sdoc", "~> 1.0", ">= 1.0.0", group: :doc
gem "serviceworker-rails", "~> 0.6", ">= 0.6.0"
